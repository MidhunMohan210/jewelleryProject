...
function Contact() {
  ...
  return (
    <div className="bg-gray-50">
      ...
      >
        <motion.div variants={fadeInUp} className="absolute bottom-8 left-6 sm:left-8">
          <motion.div
          ...
          <div className="mt-4">
            <motion.h1 variants={fadeInUp} className="text-2xl sm:text-4xl font-bold">
              Contact Us
            </motion.h1>
            <motion.p
              variants={fadeInUp}
            ...
            >
              We craft timeless elegance with precision and passion. Our exquisite collection
              blends traditional artistry with modern designs, celebrating life's special moments.
            </motion.p>
          </div>
        </motion.div>
      </motion.div>
      ...
      <div className="max-w-4xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-center text-gray-600 mb-6">
          Our Customer Care team is available Monday – Friday, 9am to 5pm IST. <br />
         
        </p>
        <p className="text-center text-gray-600 mb-10">
          Contact us on +12 (0)20 654 4522 or use the form below to email us. Response times may
          take up to 48 hours during busy periods.
        </p>
  ...
  <div className="max-w-7xl mx-auto">
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
      ...
      <motion.div
        ...
        whileInView="whileInView"
        viewport={{ once: true }}
        className="flex flex-col items-center group transition-all duration-1000 border-r-2 ease-in-out transform hover:scale-110"
      >
        <HiOutlineLocationMarker className="text-5xl text-gray-500 mb-4 group-hover:text-gray-700 transition-colors duration-300 ease-in-out" />
      ...
      <motion.div
        ...
        viewport={{ once: true }}
         className="flex flex-col items-center group transition-all duration-1000 border-r-2 ease-in-out transform hover:scale-110"
      >
        <HiOutlinePhone className="text-5xl text-gray-500 mb-4 group-hover:text-gray-700 transition-colors duration-300 ease-in-out" />
        <h3 className="text-lg font-semibold mb-2 group-hover:text-gray-700 transition-colors duration-300 ease-in-out">
          CONTACT INFO
        </h3>
        <p className="text-gray-600 opacity-90 group-hover:opacity-100 transition-opacity duration-300">
      ...
      <motion.div
        ...
        className="flex flex-col items-center group transition-all duration-1000 border-r-2 ease-in-out transform hover:scale-110"
      >
        <HiOutlineClock className="text-5xl text-gray-500 mb-4 group-hover:text-gray-700 transition-colors duration-300 ease-in-out" />
        <h3 className="text-lg font-semibold mb-2 group-hover:text-gray-700 transition-colors duration-300 ease-in-out">
          BUSINESS HOURS
        </h3>
        <p className="text-gray-600 opacity-90 group-hover:opacity-100 transition-opacity duration-300">
