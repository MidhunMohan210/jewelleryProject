      ...
      >
        <div className="relative overflow-hidden">
          <img
            ...
            className="w-full h-[500px] object-cover transform group-hover:scale-110 transition-transform duration-300"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-black opacity-0 group-hover:opacity-60 transition-opacity duration-300"></div>
          <motion.div
        ...
        >
          <div className="relative overflow-hidden h-full">
            ...
            >
              ...
              <motion.button
                className="bg-gray-500 hover:text-gray-900 text-textColor px-4 py-2 rounded-md font-medium hover:bg-gray-100 transition-colors duration-300"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                Shop Now
